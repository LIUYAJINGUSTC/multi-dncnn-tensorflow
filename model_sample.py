...
#		 layer 2 to 16
		with tf.variable_scope('conv2', reuse=reuse):
			...
			layer_1_output_1 = tf.image.resize_bicubic(layer_1_output,[20,20],True)
			with tf.variable_scope('layer_down2_1'):   
				layer_down2_1_output,layer_down2_1_output_concat = self.per_2x2_down_layer(layer_1_output_1, input_c_dim = 64 , useBN = True, use_b = False)
			with tf.variable_scope('layer_down2_2'):   
				layer_down2_2_output,layer_down2_2_output_concat = self.per_2x2_down_layer(layer_down2_1_output, input_c_dim = 32 , useBN = True, use_b = False)
			layer_down2_2_output = tf.image.resize_bicubic(layer_down2_2_output,[40,40],True)
   
			layer_1_output_2 = tf.image.resize_bicubic(layer_1_output,[10,10],True)
			with tf.variable_scope('layer_down4_1'):   
				layer_down4_1_output,layer_down4_1_output_concat = self.per_4x4_down_layer(layer_1_output_2, input_c_dim = 64 , useBN = True, use_b = False)
			with tf.variable_scope('layer_down4_2'):   
				layer_down4_2_output,layer_down4_2_output_concat = self.per_4x4_down_layer(layer_down4_1_output, input_c_dim = 16 , useBN = True, use_b = False)
			layer_down4_2_output = tf.image.resize_bicubic(layer_down4_2_output,[40,40],True)
   
			layer_2_output_all = tf.concat([layer_2_2_output,layer_down2_2_output,layer_down4_2_output],axis=3)
			with tf.variable_scope('reduce'):   
		...
		with tf.variable_scope('conv3', reuse=reuse):
			...
			layer_2_output_1 = tf.image.resize_bicubic(layer_2_output,[20,20],True)
			with tf.variable_scope('layer_down2_1'):   
				layer_down2_1_output,layer_down2_1_output_concat = self.per_2x2_down_layer(layer_2_output_1, input_c_dim = 64 , useBN = True, use_b = False)
			with tf.variable_scope('layer_down2_2'):   
				layer_down2_2_output,layer_down2_2_output_concat = self.per_2x2_down_layer(layer_down2_1_output, input_c_dim = 32 , useBN = True, use_b = False)
			layer_down2_2_output = tf.image.resize_bicubic(layer_down2_2_output,[40,40],True)
   
			layer_2_output_2 = tf.image.resize_bicubic(layer_2_output,[10,10],True)
			with tf.variable_scope('layer_down4_1'):   
				layer_down4_1_output,layer_down4_1_output_concat = self.per_4x4_down_layer(layer_2_output_2, input_c_dim = 64 , useBN = True, use_b = False)
			with tf.variable_scope('layer_down4_2'):   
				layer_down4_2_output,layer_down4_2_output_concat = self.per_4x4_down_layer(layer_down4_1_output, input_c_dim = 16 , useBN = True, use_b = False)
			layer_down4_2_output = tf.image.resize_bicubic(layer_down4_2_output,[40,40],True)
   
			layer_3_output_all = tf.concat([layer_3_2_output,layer_down2_2_output,layer_down4_2_output],axis=3)
			with tf.variable_scope('reduce'):   
...
#			output_1x1 = self.layer(inputdata, filter_shape = [1, 1, input_c_dim, 8], b_init = 0.0, stridemode=[1,2,2,1], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down2_3x3'):
			output_3x3 = self.layer(inputdata, filter_shape = [3, 3, input_c_dim, 32], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)   
#			with tf.variable_scope('3x3_1'):
#				output_3x3_1 = self.layer(inputdata, [1, 3, input_c_dim, 64], useBN=useBN, use_b = use_b)  
#			with tf.variable_scope('3x3_2'):
#				output_3x3 = self.layer(output_3x3_1, [3, 1, 64, 64], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down2_5x5'):
			with tf.variable_scope('5x5_1'):
				output_5x5_1 = self.layer(inputdata, filter_shape =[1, 5, input_c_dim, 24], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)  
			with tf.variable_scope('5x5_2'):
				output_5x5 = self.layer(output_5x5_1,filter_shape = [5, 1, 24, 24], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down2_7x7'):
			with tf.variable_scope('7x7_1'):
				output_7x7_1 = self.layer(inputdata, filter_shape = [1, 7, input_c_dim, 8], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)
			with tf.variable_scope('7x7_2'):
				output_7x7 = self.layer(output_7x7_1,filter_shape = [7, 1, 8, 8], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)     
#		concat_output=tf.concat([output_1x1,output_3x3,output_5x5,output_7x7],axis=3)
		concat_output=tf.concat([output_3x3,output_5x5,output_7x7],axis=3)
...
#			output_3x3 = self.layer(inputdata, filter_shape = [3, 3, 32, input_c_dim], b_init = 0.0, stridemode=[1,2,2,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [128,512,512,32])   
##			with tf.variable_scope('3x3_1'):
##				output_3x3_1 = self.layer(inputdata, [1, 3, input_c_dim, 64], useBN=useBN, use_b = use_b)  
##			with tf.variable_scope('3x3_2'):
##				output_3x3 = self.layer(output_3x3_1, [3, 1, 64, 64], useBN=useBN, use_b = use_b)     
...
#			with tf.variable_scope('5x5_1'):
#				output_5x5_1 = self.layer(inputdata, filter_shape =[1, 5, 24, input_c_dim], b_init = 0.0, stridemode=[1,1,2,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [128,256,512,24])  
#			with tf.variable_scope('5x5_2'):
#				output_5x5 = self.layer(output_5x5_1,filter_shape = [5, 1, 24, 24], b_init = 0.0, stridemode=[1,2,1,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [128,512,512,24])     
#		with tf.variable_scope('up2_7x7'):
#			with tf.variable_scope('7x7_1'):
#				output_7x7_1 = self.layer(inputdata, filter_shape = [1, 7, 8, input_c_dim], b_init = 0.0, stridemode=[1,1,2,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,256,512,8])
#			with tf.variable_scope('7x7_2'):
#				output_7x7 = self.layer(output_7x7_1,filter_shape = [7, 1, 8, 8], b_init = 0.0, stridemode=[1,2,1,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,512,512,8])     
##		concat_output=tf.concat([output_1x1,output_3x3,output_5x5,output_7x7],axis=3)
#		concat_output=tf.concat([output_3x3,output_5x5,output_7x7],axis=3)
...
#			output_1x1 = self.layer(inputdata, filter_shape = [1, 1, input_c_dim, 4], b_init = 0.0, stridemode=[1,4,4,1], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down4_3x3'):
			output_3x3 = self.layer(inputdata, filter_shape = [3, 3, input_c_dim, 16], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)   
#			with tf.variable_scope('3x3_1'):
#				output_3x3_1 = self.layer(inputdata, [1, 3, input_c_dim, 64], useBN=useBN, use_b = use_b)  
#			with tf.variable_scope('3x3_2'):
#				output_3x3 = self.layer(output_3x3_1, [3, 1, 64, 64], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down4_5x5'):
			with tf.variable_scope('5x5_1'):
				output_5x5_1 = self.layer(inputdata, filter_shape =[1, 5, input_c_dim, 12], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)  
			with tf.variable_scope('5x5_2'):
				output_5x5 = self.layer(output_5x5_1,filter_shape = [5, 1, 12, 12], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)     
		with tf.variable_scope('down4_7x7'):
			with tf.variable_scope('7x7_1'):
				output_7x7_1 = self.layer(inputdata, filter_shape = [1, 7, input_c_dim, 4], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)
			with tf.variable_scope('7x7_2'):
				output_7x7 = self.layer(output_7x7_1,filter_shape = [7, 1, 4, 4], b_init = 0.0, stridemode=[1,1,1,1], useBN=useBN, use_b = use_b)     
#		concat_output=tf.concat([output_1x1,output_3x3,output_5x5,output_7x7],axis=3)
		concat_output=tf.concat([output_3x3,output_5x5,output_7x7],axis=3)
...
#			output_3x3 = self.layer(inputdata, filter_shape = [3, 3, 16, input_c_dim], b_init = 0.0, stridemode=[1,4,4,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,512,512,16])   
##			with tf.variable_scope('3x3_1'):
##				output_3x3_1 = self.layer(inputdata, [1, 3, input_c_dim, 64], useBN=useBN, use_b = use_b)  
##			with tf.variable_scope('3x3_2'):
##				output_3x3 = self.layer(output_3x3_1, [3, 1, 64, 64], useBN=useBN, use_b = use_b)     
...
#			with tf.variable_scope('5x5_1'):
#				output_5x5_1 = self.layer(inputdata, filter_shape =[1, 5, 12, input_c_dim], b_init = 0.0, stridemode=[1,1,4,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,128,512,12])  
#			with tf.variable_scope('5x5_2'):
#				output_5x5 = self.layer(output_5x5_1,filter_shape = [5, 1, 12, 12], b_init = 0.0, stridemode=[1,4,1,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,512,512,12])     
#		with tf.variable_scope('up4_7x7'):
#			with tf.variable_scope('7x7_1'):
#				output_7x7_1 = self.layer(inputdata, filter_shape = [1, 7, 4, input_c_dim], b_init = 0.0, stridemode=[1,1,4,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,128,512,4])
#			with tf.variable_scope('7x7_2'):
#				output_7x7 = self.layer(output_7x7_1,filter_shape = [7, 1, 4, 4], b_init = 0.0, stridemode=[1,4,1,1], useBN=useBN, use_b = use_b, conv = False , out_shape = [1,512,512,4])     
##		concat_output=tf.concat([output_1x1,output_3x3,output_5x5,output_7x7],axis=3)
#		concat_output=tf.concat([output_3x3,output_5x5,output_7x7],axis=3)
...
#			output = tf.nn.relu(logits)
	...
	def train(self):
		# init the variables
		f = file('/home/lyj/tensorflow_code/DnCNN-tensorflow-master/denoise_sample_sigma_25_down_sample_ensemeble_no_1x1_data_augument.txt','w+')
...
#			self.writer.add_summary(summary, epoch)
	...
	def save(self,counter):
		...
		model_dir = "denoise_sample_sigma_down_sample_no_1x1_25_ensemeble_no_1x1_data_augument_%s_%s_%s" % (self.trainset, \
...
#		pdb.set_trace()  
	...
	def test(self):
		"""Test DnCNN"""
		f = file('/home/lyj/tensorflow_code/DnCNN-tensorflow-master/test_denoise_sigma_down_sample_no_1x1_50_ensemeble_no_1x1_data_augument_2.txt','w+')
